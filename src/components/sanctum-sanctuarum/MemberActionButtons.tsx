// src/components/sanctum-sanctuarum/MemberActionButtons.tsx
...
export default function MemberActionButtons({ memberSlug }: Props) {
    ...
    return (
        <div>
            <Link href={`/sanctum-sanctuarum/members/edit/${memberSlug}`} className="text-amber-400 hover:underline mr-4">
                Edit
            </Link>
