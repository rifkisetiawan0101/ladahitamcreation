// src/components/sanctum-sanctuarum/AchievementActionButtons.tsx
"use client";
...
export default function AchievementActionButtons({ achievementSlug }: Props) {
    ...
    return (
        <div>
            <Link href={`/sanctum-sanctuarum/achievements/edit/${achievementSlug}`} className="text-amber-400 hover:underline mr-4">
                Edit
            </Link>
