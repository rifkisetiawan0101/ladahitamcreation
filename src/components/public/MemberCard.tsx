...
export default function MemberCard({ member }: MemberCardProps) {
    ...
    return (
        ...
        >
            <div className="relative h-32 w-32 mb-4 rounded-full overflow-hidden ring-2 ring-amber-200/50 transition-all duration-1000 group-hover:ring-0 group-hover:ring-amber-200/50">
                <Image
                    src={imageUrl}
