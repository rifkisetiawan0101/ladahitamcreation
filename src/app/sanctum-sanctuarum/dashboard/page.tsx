// src/app/sanctum-sanctuarum/dashboard/page.tsx
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard 
                    ...
                    value={projectCount} 
                    icon={Package} 
                    href="/sanctum-sanctuarum/projects"
                />
                <StatCard 
                    title="Total Members" 
                    value={memberCount} 
                    icon={Users}
                    href="/sanctum-sanctuarum/members"
                />
                <StatCard 
                    title="Total Achievements" 
                    value={achievementCount} 
                    icon={Award}
                    href="/sanctum-sanctuarum/achievements"
                />
                <StatCard 
                    title="Team Info" 
                    value={teamInfo ? 1 : 0} 
                    icon={FileText}
                    href="/sanctum-sanctuarum/team-info"
                />
            </div>
