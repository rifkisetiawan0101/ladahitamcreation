// src/app/sanctum-sanctuarum/achievements/page.tsx

import prisma from '@/lib/prisma';
import Link from 'next/link';
import AchievementActionButtons from '@/components/sanctum-sanctuarum/AchievementActionButtons';
    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-8">
                ...
                <Link 
                    href="/sanctum-sanctuarum/achievements/new" 
